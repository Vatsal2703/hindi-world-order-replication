...
def main():
    ...
    # The paper used exactly 1,996. Let's save them as reference_sentences.pkl
    # so the variant generator knows which ones to permute.
    save_pickle(
        valid_sentences,
        os.path.join(OUTPUT_DIR, "reference_sentences.pkl")
    )

    # 4. Also save as valid_sentences.pkl to keep your old scripts working
    save_pickle(
        valid_sentences,
